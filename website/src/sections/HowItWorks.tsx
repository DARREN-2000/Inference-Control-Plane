      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-24 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-zinc-400">
            Inference Control Plane sits transparently between your application
            and your AI providers. Written in Python with FastAPI and Asyncpg,
            it processes thousands of requests per second with near-zero latency
            overhead.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            >
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                Send standard OpenAI-formatted requests to the Inference Control
                Plane Gateway instead of directly to providers. No SDK changes
                required.
              </p>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-white mb-3">
                2. Inference Control Plane Control Plane
              </h3>
              <ul className="space-y-3 text-sm text-zinc-300">
                <li className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-emerald-400" /> Auth &
                  Rate Limiting
                </li>
                <li className="flex items-center gap-2">
                  <Lock className="w-4 h-4 text-amber-400" /> PII Redaction
                </li>
                <li className="flex items-center gap-2">
                  <Database className="w-4 h-4 text-violet-400" /> Semantic
                  Cache Check
                </li>
                <li className="flex items-center gap-2">
                  <ArrowRight className="w-4 h-4 text-cyan-400" /> Dynamic
                  Routing
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                Requests are securely executed against the optimal provider.
                Responses are normalized, metrics are logged, and results are
                returned.
              </p>
              <div className="flex gap-2">
                <div className="flex-1 p-2 bg-white/5 rounded border border-white/5 text-center text-xs text-zinc-500">
                  OpenAI
                </div>
                <div className="flex-1 p-2 bg-white/5 rounded border border-white/5 text-center text-xs text-zinc-500">
                  Anthropic
