    ...
    <section className="py-24 bg-black border-t border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-zinc-400 mb-12 max-w-2xl mx-auto">
          Everything you need to set up, configure, and scale your AI gateway.
        </p>
          ...
          {[
            {
              ...
              icon: Terminal,
              desc: "Get up and running in 5 minutes with Docker.",
            },
            {
              title: "API Reference",
              icon: Code2,
              desc: "Detailed documentation for all configuration endpoints.",
            },
            {
              title: "Deployment Specs",
              icon: Book,
              desc: "Best practices for production deployments on Kubernetes.",
            },
          ].map((item, i) => (
            <a
              key={i}
              href="#"
              className="group p-6 rounded-xl border border-white/5 bg-zinc-950 hover:bg-zinc-900 transition-colors block text-left"
            >
