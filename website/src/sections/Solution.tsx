        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zinc-400">
              Replace dozens of messy SDKs with a single, intelligent proxy.
              Inference Control Plane handles the complexity of caching,
              routing, and fallbacks transparently.
            </p>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                desc: "100% compatible with OpenAI SDKs. Just change the base URL.",
              },
              {
                title: "Instant Semantic Caching",
                desc: "Sub-millisecond responses for similar queries out-of-the-box.",
              },
              {
                title: "Automatic Fallbacks",
                desc: "If GPT-4 fails, instantly route to Claude 3 with zero latency penalty.",
              },
            ].map((feature, i) => (
