    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            Intelligent routing, semantic caching, and real-time observability
            for AI inference traffic. Built for extreme scale and zero-trust
            security.
          </motion.p>
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="gap-2 w-full sm:w-auto glass"
            >
              ...
              <div className="rounded-xl border border-white/5 bg-black backdrop-blur-xl shadow-2xl overflow-hidden relative">
                ...
                <div className="h-10 border-b border-white/5 bg-white/5 flex items-center px-4 gap-2">
                  ...
                  <button
                    ...
                    className="text-zinc-500 hover:text-white absolute right-4 focus:outline-none"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
