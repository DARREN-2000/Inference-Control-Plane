...
export const Architecture = () => {
  return (
    <section
      id="architecture"
      className="py-24 relative overflow-hidden bg-zinc-950 border-t border-b border-white/5"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-zinc-400 mb-8">
              Inference Control Plane sits transparently between your
              application and your AI providers. Written in Python with FastAPI
              and Asyncpg, it's designed to process thousands of requests per
              second with near-zero latency overhead.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Easily horizontally scalable. Deploy as many nodes as you need.",
                },
                {
                  title: "Redis Backed",
                  desc: "Distributed rate limiting and semantic caching layer.",
                },
                {
