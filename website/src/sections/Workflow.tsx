        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-zinc-400 mb-8 leading-relaxed">
              When OpenAI goes down, your app shouldn't. Inference Control Plane
              detects timeouts and automatically routes the exact same request
              to Anthropic, entirely transparent to your end-user.
            </p>
                ...
                <AnimatePresence>
                  ...
                  {step >= 3 && (
                    ...
                    >
                      <span>Inference Control Plane:</span>
                      <span>
                        Executing Fallback Strategy (Anthropic Claude-3)
                      </span>
                    </motion.div>
                  )}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-emerald-500/70 mt-1">
                          Total Latency: 5.8s • Client oblivious to failure
                        </div>
                      </div>
                    </motion.div>
                  )}
