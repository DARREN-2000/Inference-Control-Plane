...
const roadmapItems = [
  {
    status: "done",
    quarter: "Q1 2024",
    title: "Core Proxy & Caching",
    desc: "Redis-backed semantic caching and basic OpenAI routing.",
  },
  {
    status: "done",
    quarter: "Q2 2024",
    title: "Observability & Tracing",
    desc: "OpenTelemetry integration and latency metrics dashboard.",
  },
  {
    status: "current",
    quarter: "Q3 2024",
    title: "Enterprise Controls",
    desc: "PII redaction, RBAC, and virtual key management.",
  },
  {
    status: "planned",
    quarter: "Q4 2024",
    title: "Edge Deployment",
    desc: "Wasm edge worker support for ultra-low latency caching.",
  },
];
          ...
          {roadmapItems.map((item, i) => (
            <div key={i} className="relative pl-8 md:pl-0">
              ...
              <div>
                ...
                <h3
                  className={`text-lg font-semibold ${item.status === "planned" ? "text-zinc-400" : "text-white"}`}
                >
                  {item.title}
                </h3>
