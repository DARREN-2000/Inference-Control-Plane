    ...
    <main className="cp-shell">
      <header className="cp-card cp-card-strong mb-4 p-5 md:p-7 cp-animate cp-animate-delay-1">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="cp-label text-[var(--accent-strong)]">
              Inference Platform
            </p>
            ...
            <a
              ...
              className="mt-4 inline-block text-sm font-medium text-[var(--accent-strong)] hover:underline"
            >
        ...
        <article className="cp-card p-5 md:p-6 cp-animate cp-animate-delay-2">
            ...
            <fieldset disabled={isLoading} className="space-y-3">
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-1">
                  <label
                    htmlFor="userId"
                    className="cp-label block text-neutral-600"
                  >
                    User ID{" "}
          ...
          {isDemoMode && (
            <p className="mt-3 text-xs text-neutral-600">
              Demo mode is enabled. Responses and logs are simulated for
              preview.
            </p>
          )}
          ...
          {error && (
            <p
              role="alert"
              className="mt-4 rounded-xl border border-red-300 bg-red-50 px-3 py-2 text-sm text-[var(--danger)]"
            >
              {error}
            </p>
          )}
          ...
          {result && (
            <div
              aria-live="polite"
              className="mt-5 space-y-3 rounded-2xl border border-[var(--border)] bg-[#fffdf8] p-4"
            >
        ...
        <div className="cp-grid grid-cols-1 gap-4">
          ...
          <article className="cp-card p-5 cp-animate cp-animate-delay-4">
            ...
            <ul className="mt-3 space-y-2 text-sm text-neutral-700">
              {activity.map((item) => (
                <li
                  key={item}
                  className="rounded-lg border border-[var(--border)] bg-[#fffdf8] p-2"
                >
                  {item}
                </li>
              ))}
          ...
          <article className="cp-card p-5 cp-animate cp-animate-delay-5">
            ...
            {logsError && (
              <p
                role="alert"
                className="mt-3 rounded-xl border border-red-300 bg-red-50 px-3 py-2 text-sm text-[var(--danger)]"
              >
                {logsError}
              </p>
            )}
