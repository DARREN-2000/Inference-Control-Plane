...
_Note: If you update `.env` while Docker is running, you must restart the API container:_
...
_(If the dashboard container isn't running in your compose file, you can start it manually from the `frontend/` directory using `npm run dev`)._
