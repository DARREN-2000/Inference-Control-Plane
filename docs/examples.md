...
try:
    response = client.chat.completions.create(
        ...
        extra_body={
            "inference_control_plane_fallback_models": ["claude-3-5-sonnet", "gpt-3.5-turbo"]
        }
    )
...
*What happens in Inference Control Plane:*
...
const client = new OpenAI({ baseURL: 'http://localhost:8000/v1', apiKey: 'sk-inference-control-plane...' });
